    ...
    <div className="group py-8 border-b border-slate-100 last:border-0">
      <div className="flex flex-col md:flex-row gap-6 md:gap-10">
        ...
        <div className="flex-1 order-2 md:order-1">
          ...
          {/* Action Icons - Replaced old Share button with individual icons */}
          <div className="flex items-center gap-3 text-slate-500 relative">
            ...
            <button
              ...
              className="w-10 h-10 bg-black text-white rounded-full flex items-center justify-center hover:bg-slate-800 transition-all"
            ...
            <button
              ...
              className="w-10 h-10 bg-green-500 text-white rounded-full flex items-center justify-center hover:bg-green-600 transition-all"
            ...
            <button
              ...
              className="w-10 h-10 bg-slate-800 text-white rounded-full flex items-center justify-center hover:bg-slate-700 transition-all border border-slate-700"
